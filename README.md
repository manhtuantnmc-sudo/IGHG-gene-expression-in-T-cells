# Analysis Code for Manuscript Figures

This repository contains R scripts used to generate analyses and figures reported in the manuscript, including **Figure 1, Figure S1, and Figure S2**. Each figure has its own folder with detailed scripts and instructions.
